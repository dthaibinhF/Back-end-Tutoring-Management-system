...
/*!40000 ALTER TABLE `account`
    DISABLE KEYS */;
INSERT INTO `account`
VALUES (1, 'Đặng Thái Bình', 'dthaibinh03@gmail.com', '0939464077', '{noop}Dthaibinh@1234', 1, '2025-02-10'),
       (2, 'Donnie Gottlieb', 'nhut@gmail.com', '0123456780',
        '{bcrypt}$2a$12$KBdErJidVwMvzqN/mlQQVurMueux6oaT0t1KXQkfFTn98QYDVP6Jm', 2, '2025-02-20'),
       (3, 'Phan Tấn Phát', 'phat@gmail.com', '0123456789',
        '{bcrypt}$2a$12$aWEDx6JpvXScPRVk7cTxkeKh4e5qxQsk91wGtS.KVS2/L0/AcU.B2', 3, '2025-02-20'),
       (4, 'Bùi Gia Mỹ', 'my@gmail.com', '0987654321',
        '{bcrypt}$2a$12$HRPpgmQ2SuIbf1HfJEMXGeSlmHQ7SgucyVTJSpZXJXYT6PMFlJJES', 4, '2025-02-20'),
       (5, 'Nguyễn Hoàng Trung', 'trung@gmail.com', '0333098311',
        '{bcrypt}$2a$12$HRPpgmQ2SuIbf1HfJEMXGeSlmHQ7SgucyVTJSpZXJXYT6PMFlJJES', 5, '2025-02-21');
/*!40000 ALTER TABLE `account`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `account_details`
    DISABLE KEYS */;
INSERT INTO `account_details`
VALUES (1, 'Cần Thơ, Việt Nam'),
       (2, 'Lake Rhoda'),
       (3, 'Tiền Giang, Việt Nam'),
       (4, 'Cái Bè, Việt Nam'),
       (5, 'Hậu Giang, Việt Nam');
/*!40000 ALTER TABLE `account_details`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `class`
    DISABLE KEYS */;
INSERT INTO `class`
VALUES (1, '12N1', 'NORMAL', 12, 50),
       (2, '12N2', 'NORMAL', 12, 50),
       (3, '12N3', 'NORMAL', 12, 50),
       (4, '12NC1', 'NORMAL', 12, 50),
       (5, '12NC2', 'NORMAL', 12, 50),
       (6, '12V1', 'NORMAL', 12, 50);
/*!40000 ALTER TABLE `class`
    ENABLE KEYS */;
UNLOCK TABLES;
...
(
  ...
  AUTO_INCREMENT = 43
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='class period';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40000 ALTER TABLE `period_time`
    DISABLE KEYS */;
INSERT INTO `period_time`
VALUES (1, 'monday-1', 'monday', '07:20:00', '09:00:00'),
       (2, 'monday-2', 'monday', '09:20:00', '11:00:00'),
       (3, 'monday-3', 'monday', '13:20:00', '15:00:00'),
       (4, 'monday-4', 'monday', '15:20:00', '17:00:00'),
       (5, 'monday-5', 'monday', '17:20:00', '19:00:00'),
       (6, 'monday-6', 'monday', '19:20:00', '21:00:00'),
       (7, 'tuesday-1', 'tuesday', '07:20:00', '09:00:00'),
       (8, 'tuesday-2', 'tuesday', '09:20:00', '11:00:00'),
       (9, 'tuesday-3', 'tuesday', '13:20:00', '15:00:00'),
       (10, 'tuesday-4', 'tuesday', '15:20:00', '17:00:00'),
       (11, 'tuesday-5', 'tuesday', '17:20:00', '19:00:00'),
       (12, 'tuesday-6', 'tuesday', '19:20:00', '21:00:00'),
       (13, 'wednesday-1', 'wednesday', '07:20:00', '09:00:00'),
       (14, 'wednesday-2', 'wednesday', '09:20:00', '11:00:00'),
       (15, 'wednesday-3', 'wednesday', '13:20:00', '15:00:00'),
       (16, 'wednesday-4', 'wednesday', '15:20:00', '17:00:00'),
       (17, 'wednesday-5', 'wednesday', '17:20:00', '19:00:00'),
       (18, 'wednesday-6', 'wednesday', '19:20:00', '21:00:00'),
       (19, 'thursday-1', 'thursday', '07:20:00', '09:00:00'),
       (20, 'thursday-2', 'thursday', '09:20:00', '11:00:00'),
       (21, 'thursday-3', 'thursday', '13:20:00', '15:00:00'),
       (22, 'thursday-4', 'thursday', '15:20:00', '17:00:00'),
       (23, 'thursday-5', 'thursday', '17:20:00', '19:00:00'),
       (24, 'thursday-6', 'thursday', '19:20:00', '21:00:00'),
       (25, 'friday-1', 'friday', '07:20:00', '09:00:00'),
       (26, 'friday-2', 'friday', '09:20:00', '11:00:00'),
       (27, 'friday-3', 'friday', '13:20:00', '15:00:00'),
       (28, 'friday-4', 'friday', '15:20:00', '17:00:00'),
       (29, 'friday-5', 'friday', '17:20:00', '19:00:00'),
       (30, 'friday-6', 'friday', '19:20:00', '21:00:00'),
       (31, 'saturday-1', 'saturday', '07:20:00', '09:00:00'),
       (32, 'saturday-2', 'saturday', '09:20:00', '11:00:00'),
       (33, 'saturday-3', 'saturday', '13:20:00', '15:00:00'),
       (34, 'saturday-4', 'saturday', '15:20:00', '17:00:00'),
       (35, 'saturday-5', 'saturday', '17:20:00', '19:00:00'),
       (36, 'saturday-6', 'saturday', '19:20:00', '21:00:00'),
       (37, 'sunday-1', 'sunday', '07:20:00', '09:00:00'),
       (38, 'sunday-2', 'sunday', '09:20:00', '11:00:00'),
       (39, 'sunday-3', 'sunday', '13:20:00', '15:00:00'),
       (40, 'sunday-4', 'sunday', '15:20:00', '17:00:00'),
       (41, 'sunday-5', 'sunday', '17:20:00', '19:00:00'),
       (42, 'sunday-6', 'sunday', '19:20:00', '21:00:00');
/*!40000 ALTER TABLE `period_time`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `period_time_class`
    DISABLE KEYS */;
INSERT INTO `period_time_class`
VALUES (5, 1),
       (17, 1),
       (29, 1),
       (6, 2),
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='luu tru diem danh';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40000 ALTER TABLE `school`
    DISABLE KEYS */;
INSERT INTO `school`
VALUES (1, 'Truong THPT Châu Văn Liêm'),
       (2, 'Truong THPT Thực Hành Sư Phạm'),
       (3, 'Truong THPT Phan Ngọc Hiển'),
       (4, 'Truong THPT Nguyễn Việt Hồng'),
       (5, 'Truong THPT Nguyễn Việt Dũng'),
       (6, 'Truong THPT An Khánh'),
       (7, 'Truong THPT Bình Minh'),
       (8, 'Truong THPT Nguyễn Bỉnh Khiêm'),
       (9, 'Truong THPT Tầm Vu');
/*!40000 ALTER TABLE `school`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `school_year`
    DISABLE KEYS */;
INSERT INTO `school_year`
VALUES (1, '2024-09-05', '2025-05-31', 2024, 2025);
/*!40000 ALTER TABLE `school_year`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `school_year_grade`
    DISABLE KEYS */;
INSERT INTO `school_year_grade`
VALUES (1, 10),
       (1, 11),
       (1, 12);
/*!40000 ALTER TABLE `school_year_grade`
...
/*!40000 ALTER TABLE `student`
    DISABLE KEYS */;
INSERT INTO `student`
VALUES (1, 3, 6, 1, 12, '2025-01-01', '2025-04-30', 1),
       (2, 4, 2, 4, 12, '2025-01-01', '2025-04-30', 1);
/*!40000 ALTER TABLE `student`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `student_fee`
    DISABLE KEYS */;
INSERT INTO `student_fee`
VALUES (1, 'lớp 12 Học kỳ 2', 1800000.0000, '2025-01-01', '2025-04-30'),
       (2, 'lớp 11 Học kỳ 2', 2000000.0000, '2025-01-01', '2025-04-30'),
       (3, 'lớp 10 Học kỳ 2', 2000000.0000, '2025-01-01', '2025-04-30');
/*!40000 ALTER TABLE `student_fee`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `student_pay_fee`
    DISABLE KEYS */;
/*!40000 ALTER TABLE `student_pay_fee`
    ENABLE KEYS */;
UNLOCK TABLES;
...
(
    ...
    PRIMARY KEY (`id`),
    KEY `account_details_id` (`account_details_id`),
    CONSTRAINT `teacher_ibfk_1` FOREIGN KEY (`account_details_id`) REFERENCES `account_details` (`id`)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='thoi khoa bieu chung cho tung nhom trong tuan';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-03-15 23:57:31
